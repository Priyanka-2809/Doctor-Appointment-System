...
class AppointmentBooking
{
	...
	{
		doctorName.add("Arjun Reddy");
		doctorName.add("Shiva Kumar");
		doctorName.add("Prashant Neel");
		doctorName.add("Krishn Kanth");
		doctorName.add("Naveen Chandra");
		doctorName.add("Danush Kumar");
		doctorName.add("Ravi Kanth");
		...
		doctorPassword.add("Arjun123");
		doctorPassword.add("Shiva123");
		doctorPassword.add("Prashant123");
		doctorPassword.add("Krishn123");
		doctorPassword.add("Naveen123");
		doctorPassword.add("Danush123");
		doctorPassword.add("Ravi123");
